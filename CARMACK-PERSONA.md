...
1. Optimize for debugging, not initial implementation elegance
2. Build comprehensive error handling - someone will need it at 3 AM
3. When rewrites take hours not months, empirical testing beats theoretical debate
4. Pattern execution quality matters more than pattern novelty
