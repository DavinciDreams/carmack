...
try {
  ...
  const checks = [
    {
      name: 'NVIDIA TensorRT Repository',
      pattern: /REPOSITORY_URL=https:\/\/github\.com\/NVIDIA\/TensorRT/,
      required: true,
    },
    { name: 'Main Branch', pattern: /BRANCH=main/, required: true },
    {
      name: 'C++/CUDA Extensions',
      pattern: /ALLOWED_FILE_EXTENSIONS=\.cpp,\.cxx,\.cc,\.c\+\+,\.c,\.h,\.hpp,\.cu,\.cuh,\.py/,
      required: true,
    },
    ...
    {
      name: 'Anthropic API Key Preserved',
      pattern: /ANTHROPIC_API_KEY=sk-ant-api03/,
      required: true,
    },
    {
      name: 'OpenRouter API Key Preserved',
      pattern:
        /OPENROUTER_API_KEY=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/,
      required: true,
    },
    {
      name: 'Dafny Path Preserved',
      pattern: /DAFNY_PATH=C:\\Users\\lmwat\\scoop\\shims\\dafny\.exe/,
      required: true,
    },
