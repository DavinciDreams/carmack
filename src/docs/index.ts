...
export class DocumentationSystem {
   ...
   */
  async generateAPIDocumentation(options: {
    outputPath?: string;
   ...
   */
  async generateArchitectureDocumentation(options: {
    outputPath?: string;
    format?: 'markdown' | 'html' | 'json';
  } = {}): Promise<DocumentationResult> {
    const request: DocumentationRequest = {
   ...
   */
  async generatePatternDocumentation(options: {
    outputPath?: string;
    format?: 'markdown' | 'html' | 'json';
  } = {}): Promise<DocumentationResult> {
    const request: DocumentationRequest = {
   ...
   */
  async generateUsageDocumentation(options: {
    outputPath?: string;
    format?: 'markdown' | 'html' | 'json';
  } = {}): Promise<DocumentationResult> {
    const request: DocumentationRequest = {
   ...
   */
  async generateAllDocumentation(options: {
    outputDir?: string;
    format?: 'markdown' | 'html' | 'json';
    includePrivate?: boolean;
    includeTests?: boolean;
   ...
   */
  async generateAndWriteAll(options: {
    outputDir?: string;
    format?: 'markdown' | 'html' | 'json';
    includePrivate?: boolean;
    includeTests?: boolean;
...
export const generateAPIDocumentation = (options?: Parameters<DocumentationSystem['generateAPIDocumentation']>[0]) =>
  documentationSystem.generateAPIDocumentation(options);

export const generateArchitectureDocumentation = (options?: Parameters<DocumentationSystem['generateArchitectureDocumentation']>[0]) =>
  documentationSystem.generateArchitectureDocumentation(options);

export const generatePatternDocumentation = (options?: Parameters<DocumentationSystem['generatePatternDocumentation']>[0]) =>
  documentationSystem.generatePatternDocumentation(options);

export const generateAllDocumentation = (options?: Parameters<DocumentationSystem['generateAllDocumentation']>[0]) =>
  documentationSystem.generateAllDocumentation(options);

export const generateAndWriteAll = (options?: Parameters<DocumentationSystem['generateAndWriteAll']>[0]) =>
