...
/**
 * UnifiedAnalyzer performs static analysis and generates markdown/type error reports for TypeScript projects.
 */
export class UnifiedAnalyzer {
  ...
  public analyze(this: UnifiedAnalyzer): { issues: z.infer<typeof IssueSchema>[]; stats: UnifiedAnalyzer['stats'] } {
